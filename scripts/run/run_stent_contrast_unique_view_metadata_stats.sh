...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/stent_contrast_unique_view_metadata_stats}"
...
CMD=(
  ...
  scripts/analysis/pretrain_metadata/analyze_stent_contrast_unique_view_metadata.py
