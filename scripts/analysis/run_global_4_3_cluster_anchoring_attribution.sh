...
GLOBAL3_ROOT="${GLOBAL3_ROOT:-outputs/global_4_3_view_classification_unique_view}"
...
SEED="${SEED:-42}"
LOG_FILE="${LOG_FILE:-run_global_4_3_cluster_anchoring.log}"
...
CMD=(
  ...
  python scripts/analysis/global_4_3_cluster_anchoring_attribution.py
  --global3-root "${GLOBAL3_ROOT}"
...
echo "[run_global_4_3_cluster_anchoring_attribution] ROOT_DIR=${ROOT_DIR}"
echo "[run_global_4_3_cluster_anchoring_attribution] OUTPUT_ROOT=${OUTPUT_ROOT}"
printf '[run_global_4_3_cluster_anchoring_attribution] CMD:'
printf ' %q' "${CMD[@]}"
printf '\n'
exec "${CMD[@]}"
