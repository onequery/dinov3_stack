...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/8_segmentation_linear_probe}"
DEVICE="${DEVICE:-cuda}"
...
echo "[run_3_segmentation_linear_probe] ROOT_DIR=${ROOT_DIR}"
echo "[run_3_segmentation_linear_probe] CONDA_ENV=${CONDA_ENV} CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES}"
echo "[run_3_segmentation_linear_probe] OUTPUT_ROOT=${OUTPUT_ROOT}"
...
CMD=(
  ...
  python scripts/analysis/3_segmentation_linear_probe.py
...
printf '[run_3_segmentation_linear_probe] CMD:'
printf ' %q' "${CMD[@]}"
printf '\n'
