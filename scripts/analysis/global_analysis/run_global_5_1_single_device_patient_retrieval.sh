...
IMAGE_ROOT="${IMAGE_ROOT:-input/global_analysis_5_per_device_patient_retrieval/alluraxper_unique_view_subset/images}"
DCM_ROOT="${DCM_ROOT:-input/global_analysis_5_per_device_patient_retrieval/alluraxper_unique_view_subset/dicoms}"
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/analysis2_rep_analysis/global_5_per_device_patient_retrieval/alluraxper}"
RETRIEVAL_ROOT="${RETRIEVAL_ROOT:-${OUTPUT_ROOT}/retrieval_benchmark}"
LOG_FILE="${LOG_FILE:-}"
ANALYSIS_TITLE="${ANALYSIS_TITLE:-Global Analysis 5-1}"
ANALYSIS_NAME="${ANALYSIS_NAME:-global_5_1_single_device_patient_retrieval_alluraxper_unique_view}"
SUMMARY_PREFIX="${SUMMARY_PREFIX:-summary_global_5_1}"
FIGURE_PREFIX="${FIGURE_PREFIX:-fig_global5_1}"
PATIENT_MARKDOWN_NAME="${PATIENT_MARKDOWN_NAME:-analysis_global_5_1_patient_retrieval.md}"
ANCHORING_MARKDOWN_NAME="${ANCHORING_MARKDOWN_NAME:-analysis_global_5_1_cluster_anchoring_attribution.md}"
ANCHORING_LOG_PREFIX="${ANCHORING_LOG_PREFIX:-global_5_1_cluster_anchoring_attribution}"
