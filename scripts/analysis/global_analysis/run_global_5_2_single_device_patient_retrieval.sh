...
IMAGE_ROOT="${IMAGE_ROOT:-input/global_analysis_5_2_integris_allura_flat_detector_unique_view_subset/images}"
DCM_ROOT="${DCM_ROOT:-input/global_analysis_5_2_integris_allura_flat_detector_unique_view_subset/dicoms}"
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/analysis2_rep_analysis/global_5_2_single_device_patient_retrieval_integris_allura_flat_detector_unique_view}"
