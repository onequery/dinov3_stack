...
OUTPUT_ROOT="${OUTPUT_ROOT:-input/global_analysis_5_philips_integris_h_unique_view_subset}"
LOG_EVERY="${LOG_EVERY:-200}"
OVERWRITE="${OVERWRITE:-0}"

CMD=(
  conda run --no-capture-output -n "${CONDA_ENV}" python -u
  scripts/analysis/global_analysis/build_global_5_philips_integris_h_unique_view_subset.py
