...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/fm_improve_exp1-input_policy/input_v4_border_suppression/downstream_only}"
...
CMD=(
  ...
  scripts/exp/fm_improve_exp1-input_policy/analysis/run_input_v4_border_suppression.py
