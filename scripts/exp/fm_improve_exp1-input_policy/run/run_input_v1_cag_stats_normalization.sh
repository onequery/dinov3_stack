...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/fm_improve_exp1-input_policy/input_v1_cag_stats_normalization/downstream_only}"
STATS_JSON="${STATS_JSON:-outputs/fm_improve_exp1-input_policy/input_v1_cag_stats_normalization/stats/cag_stats_unique_view_train.json}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  ...
  python scripts/exp/fm_improve_exp1-input_policy/analysis/run_input_v1_cag_stats_normalization.py
...
echo "[run_input_v1_cag_stats_normalization] ROOT_DIR=${ROOT_DIR}"
echo "[run_input_v1_cag_stats_normalization] OUTPUT_ROOT=${OUTPUT_ROOT}"
printf '[run_input_v1_cag_stats_normalization] CMD:'
printf ' %q' "${CMD[@]}"
printf '\n'
exec "${CMD[@]}"
