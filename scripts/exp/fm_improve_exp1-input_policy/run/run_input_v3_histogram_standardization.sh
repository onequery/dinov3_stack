...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/fm_improve_exp1-input_policy/input_v3_histogram_standardization/downstream_only}"
...
CMD=(
  ...
  scripts/exp/fm_improve_exp1-input_policy/analysis/run_input_v3_histogram_standardization.py
