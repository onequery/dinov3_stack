...
# -----------------------------
python eval_classifier.py \
--weights outputs/train/${MODEL_NAME}/1_card_cls_head_fine_tune/best_model.pth \
--input input/archive/test \
--config classification_configs/cards.yaml \
...
# # -----------------------------
# python eval_classifier.py \
# --weights outputs/train/${MODEL_NAME}/2_card_cls_full_fine_tune/best_model.pth \
# --input input/archive/test/ \
# --config classification_configs/cards.yaml \
# --model-name ${MODEL_NAME} \
...
# -----------------------------
python eval_classifier.py \
--weights outputs/train/${MODEL_NAME}/3_stent_cls_head_fine_tune/best_model.pth \
--input input/stent_split_img/test \
--config classification_configs/stent.yaml \
--model-name ${MODEL_NAME} \
...
# # -----------------------------
# python eval_classifier.py \
# --weights outputs/train/${MODEL_NAME}/4_stent_cls_full_fine_tune/best_model.pth \
# --input input/stent_split_img/test \
# --config classification_configs/stent.yaml \
# --model-name ${MODEL_NAME} \
